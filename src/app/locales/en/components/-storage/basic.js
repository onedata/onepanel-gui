const lockedImportedReadonlyCanonicalTip =
  '{{type}} storage with canonical paths as object names can only be used in readonly mode for import, since {{type}} does not support random access writes, which is required to support Onedata writes. On {{type}}, each write has to replace the entire object.';
const lockedImportedReadonlyFlatTip =
  '{{type}} storage with flat object names cannot be imported (which would imply readonly mode), as no file/directory structure can be inferred.';
...
export default {
  ...
  readonly: {
    ...
    lockedFlatTip: lockedImportedReadonlyFlatTip,
    lockedCanonicalTip: lockedImportedReadonlyCanonicalTip,
