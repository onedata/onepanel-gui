...
export default {
  ...
  credentials: {
    ...
    tipBasic: 'The credentials to authenticate with the WebDAV server. Credentials should be provided in the form "userlabel:password".',
    tipOauth2: 'The credentials to authenticate with the WebDAV server. This field should contain the userlabel for the WebDAV, while the token will be obtained and refreshed automatically in the background.',
  },
  oauth2IdP: {
    label: 'OAuth2 IdP',
