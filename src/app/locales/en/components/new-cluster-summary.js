export default {
  ...
  wayOnepanelIntro: 'Emergency Onepanel interface – this interface is limited to this cluster only and most of the features are disabled. You can only log in using your Onepanel emergency passphrase.',
