export default {
  ...
  wayOnezoneToAccess1: '– to access it, log in via Onezone',
  wayOnezoneToAccess2: 'with the same account as during registration.',
  wayOnezoneInterface1: 'You will find your cluster in the',
  wayOnezoneInterfaceClusters: 'Clusters',
  wayOnezoneInterface2: 'menu.',
  wayOnezoneInterface3: 'This interface integrates all functionalities offered by Onedata.',
  wayOnezoneTakeMe: 'Take me there now',
