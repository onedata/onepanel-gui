export default {
  ...
  wayOnezoneInterface1: 'this interface integrates all features offered by Onedata – you will find your cluster in the',
  wayOnezoneInterfaceClusters: 'Clusters',
  wayOnezoneInterface3: 'menu.',
  wayOnezoneAccessProvider: 'To access it, click the button below and sign in with your Onedata user account.',
  wayOnezoneAccessZone: 'To access it, click the button below and sign in with default admin account, that has been created in Onezone:',
  canChangePassword: 'You can change the password after logging in.',
  login: 'Username',
  password: 'Password',
  sameAsPassphrase: 'your emergency passphrase',
  wayOnepanelIntro: 'Emergency Onepanel interface – this interface is limited to this cluster only and most of its features are disabled. You can only sign in using your Onepanel emergency passphrase.',
