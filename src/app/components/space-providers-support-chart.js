...
import centeredText from 'onepanel-gui/utils/chartist/centered-text';
import pieLabels from 'onepanel-gui/utils/chartist/pie-labels';
import customCss from 'onepanel-gui/utils/chartist/custom-css';
