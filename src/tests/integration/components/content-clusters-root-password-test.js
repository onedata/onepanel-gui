...
describe('Integration | Component | content clusters root password', function () {
  setupComponentTest('content-clusters-root-password', {
    integration: true,
  });

  it('shows secret password field by default', function () {
    this.render(hbs `{{content-clusters-root-password}}`);
